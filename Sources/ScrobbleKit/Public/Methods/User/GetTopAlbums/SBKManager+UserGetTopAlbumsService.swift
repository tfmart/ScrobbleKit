...
public extension SBKManager {
     ...
     */
    func getTopAlbums(forUser user: String, period: SBKSearchPeriod = .overall, limit: Int = .sbkLimitPerPage, page: Int = .sbkFirstPage) async throws -> SBKSearchResult<SBKAlbum> {
