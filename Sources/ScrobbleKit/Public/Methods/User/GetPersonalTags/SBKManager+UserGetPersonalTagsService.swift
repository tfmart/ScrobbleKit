...
public extension SBKManager {
     ...
     */
    func getPersonalTagsForArtists(fromUser user: String, tag: String, limit: Int = .sbkLimitPerPage, page: Int = .sbkFirstPage) async throws -> SBKSearchResult<SBKArtist> {
    ...
    /**
     ...
     - Note: See [Last.fm's user.getPersonalTags documentation](https://www.last.fm/api/show/user.getPersonalTags) for more information.
     */
    func getPersonalTagsForTracks(fromUser user: String, tag: String, limit: Int = .sbkLimitPerPage, page: Int = .sbkFirstPage) async throws -> SBKSearchResult<SBKTrack> {
        let service = UserGetPersonalTagsService(
            user: user,
            tag: tag,
            taggingType: "track",
    ...
    /**
     ...
     - Note: See [Last.fm's user.getPersonalTags documentation](https://www.last.fm/api/show/user.getPersonalTags) for more information.
     */
    func getPersonalTagsForAlbums(fromUser user: String, tag: String, limit: Int = .sbkLimitPerPage, page: Int = .sbkFirstPage) async throws -> SBKSearchResult<SBKAlbum> {
        let service = UserGetPersonalTagsService(
            user: user,
            tag: tag,
            taggingType: "album",
