...
public extension SBKManager {
     ...
     */
    func getRecentTracks(from user: String, limit: Int = 50, page: Int = 1, from: TimeInterval? = nil, extended: Bool? = nil, to: TimeInterval? = nil) async throws -> SBKSearchResult<SBKTrack> {
    ...
    /**
     ...
     - Note: See [Last.fm's user.getRecentTracks documentation](https://www.last.fm/api/show/user.getRecentTracks) for more information.
     */
    func getRecentTracks(from user: String, limit: Int = 50, page: Int = 1, from: TimeInterval? = nil, extended: Bool? = nil, to: TimeInterval? = nil, completion: ((SBKSearchResult<SBKTrack>?, Error?) -> Void)?) {
        let service = UserGetRecentTracksService(
            user: user,
            limit: limit,
            page: page,
