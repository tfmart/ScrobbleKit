...
public extension SBKManager {
     ...
     */
    func getTopArtists(forUser user: String, period: SBKSearchPeriod = .overall, limit: Int = .sbkLimitPerPage, page: Int = .sbkFirstPage) async throws -> SBKSearchResult<SBKArtist> {
