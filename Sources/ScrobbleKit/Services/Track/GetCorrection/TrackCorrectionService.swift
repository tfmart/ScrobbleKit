...
//    typealias ResponseType = SBKTrackCorrectionResponse
//
//    var sbkMethod: SBKMethod = .getCorrectedTrackInfo
//    var queries: [URLQueryItem]
//    var httpMethod: SBKHttpMethod = .geta
//
//    var apiKey: String
//    var secretKey: String?
//
//    init(trackName: String, artistName: String, apiKey: String, secretKey: String? = nil) {
//        self.apiKey = apiKey
